...
public:
	...
	virtual Actor* crearInstanciaTronco(float _x, float _y) = 0;
	virtual Actor* crearInstanciaCharco(float _x, float _y) = 0;
	virtual Actor* crearInstanciaRoca(float _x, float _y) = 0;
	virtual Actor* crearInstanciaTanqueEnemigo(float _x, float _y) = 0;
	virtual Actor* crearInstanciaBase(float _x, float _y) = 0;
	virtual Actor* crearInstanciaAguila(float _x, float _y) = 0;
