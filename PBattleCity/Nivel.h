...
const unsigned char celdaSimbolo_Aguila = 'A';
...
const vector<string> mapaNivel1 ={
	...
	string{"@                @@@              @@              @@@                               ###            @         @"},
	string{"@                @@@              @@              @@@                                              @         @"},
	string{"@@@   @@@#####   ############            ############   #####@@@   @@   TTTTTTTTTTTTTTTTTT         @         @"},
	string{"@@@   @@@#####   ######@@######        ######@@######   #####@@@   @@                              @         @"},
	string{"@@@   @@@#####   ######@@@#####        #####@@@######   #####@@@   @@                              @         @"},
	string{"@                   ###@@@@@###@@    @@###@@@@@###                  CCCCCCCCCCCCCCCCCCC            @         @"},
	string{"@                     #########@@@@@@@@#########                    CCCCCCCCCCCCCCCCCCC            @         @"},
	string{"@                           ##############                                                         @         @"},
	string{"@   ##   ##                    ########                    ##   ##                                 @         @"},
	string{"@   #######                                                #######                                 @         @"},
...
const vector<string> mapaNivel2 = {
	...
	string{"@   #######                                                #######                                 @         @"},
	string{"@   #######   @@@######                        ######@@@   #######                                 @         @"},
	string{"@   ##   ##   @@@######                        ######@@@   ##   ##     TTTTTTTTTTTTTTTTTTT         @         @"},
	string{"@                        2   ############ 1                                                        @         @"},
	string{"@                            ##B       ##                                                          @         @"},
	string{"@                            ##        ##                                                          @         @"},
	string{"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"} };

const vector<string> mapaNivel3 = {
	string{"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"},
	string{"@S                                @@                              S                                @         @"},
	string{"@                                 @@                                                               @         @"},
	string{"@                                 @@                                                               @         @"},
...
//tronco roca y charco
const vAvatarDireccion vAvatarNingunaTroncoN2 = {
	DatosSimboloConsola{(char)205, ColorConsola_Amarillo, ColorConsola_Cafe} };
const mAvatarDireccion avatarTroncoN2{ make_pair(Direccion{Direccion_Ninguna}, vAvatarNingunaTroncoN2) };

const vAvatarDireccion vAvatarNingunaTroncoN3 = {
	DatosSimboloConsola{(char)207, ColorConsola_Amarillo, ColorConsola_Cafe} };
const mAvatarDireccion avatarTroncoN3{ make_pair(Direccion{Direccion_Ninguna}, vAvatarNingunaTroncoN3) };

const vAvatarDireccion vAvatarNingunaCharcoN2 = {
	DatosSimboloConsola{(char)207, ColorConsola_Verde, ColorConsola_Celeste} };
const mAvatarDireccion avatarCharcoN2{ make_pair(Direccion{Direccion_Ninguna}, vAvatarNingunaCharcoN2) };

const vAvatarDireccion vAvatarNingunaCharcoN3 = {
	DatosSimboloConsola{(char)207, ColorConsola_Verde, ColorConsola_Celeste} };
const mAvatarDireccion avatarCharcoN3{ make_pair(Direccion{Direccion_Ninguna}, vAvatarNingunaCharcoN3) };

const vAvatarDireccion vAvatarNingunaRocaN1 = {
	DatosSimboloConsola{(char)176, ColorConsola_Cafe, ColorConsola_Gris} };
const mAvatarDireccion avatarRocaN1{ make_pair(Direccion{Direccion_Ninguna}, vAvatarNingunaRocaN1) };

const vAvatarDireccion vAvatarNingunaRocaN2 = {
	DatosSimboloConsola{(char)207, ColorConsola_Cafe, ColorConsola_Gris} };
const mAvatarDireccion avatarRocaN2{ make_pair(Direccion{Direccion_Ninguna}, vAvatarNingunaRocaN2) };
...
const vAvatarDireccion vAvatarNingunaArbustoN3 = {
	DatosSimboloConsola{(char)190, ColorConsola_Blanco, ColorConsola_VerdeOscuro},
	DatosSimboloConsola{(char)190, ColorConsola_Blanco, ColorConsola_VerdeOscuro},
	DatosSimboloConsola{(char)190, ColorConsola_Blanco, ColorConsola_VerdeOscuro},
	...
	DatosSimboloConsola{(char)190, ColorConsola_Blanco, ColorConsola_VerdeOscuro},
	DatosSimboloConsola{(char)190, ColorConsola_Blanco, ColorConsola_VerdeOscuro} };
const mAvatarDireccion avatarArbustoN3{ make_pair(Direccion{Direccion_Ninguna}, vAvatarNingunaArbustoN3) };
...
const vAvatarDireccion vAvatarIzquierdaTanqueJugador1N2 = {
	DatosSimboloConsola{(char)220, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)220, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)220, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)13, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)196, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)4, ColorConsola_Violeta, ColorConsola_Negro},
	DatosSimboloConsola{(char)221, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)13, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)223, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)223, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)223, ColorConsola_Azul, ColorConsola_Negro} };
...
const vAvatarDireccion vAvatarArribaTanqueJugador1N2 = {
	DatosSimboloConsola{(char)220, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)179, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)220, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)13, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)219, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)4, ColorConsola_Violeta, ColorConsola_Negro},
	DatosSimboloConsola{(char)219, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)13, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)223, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)0, ColorConsola_Azul, ColorConsola_Negro},
	DatosSimboloConsola{(char)223, ColorConsola_Azul, ColorConsola_Negro} };
...
const vAvatarDireccion vAvatarIzquierdaTanqueEnemigo2 = {
	DatosSimboloConsola{(char)220, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)220, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)220, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)13, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)196, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)4, ColorConsola_Violeta, ColorConsola_Negro},
	DatosSimboloConsola{(char)221, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)13, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)223, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)223, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)223, ColorConsola_Blanco, ColorConsola_Negro} };
...
const vAvatarDireccion vAvatarArribaTanqueEnemigo2 = {
	DatosSimboloConsola{(char)220, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)179, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)220, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)13, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)219, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)4, ColorConsola_Violeta, ColorConsola_Negro},
	DatosSimboloConsola{(char)219, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)13, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)223, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)0, ColorConsola_Blanco, ColorConsola_Negro},
	DatosSimboloConsola{(char)223, ColorConsola_Blanco, ColorConsola_Negro} };
...
// aguila
const vAvatarDireccion vAvatarIzquierdaAguila = {
	DatosSimboloConsola{(char)62, ColorConsola_Amarillo, ColorConsola_Negro},
	DatosSimboloConsola{(char)254,ColorConsola_Amarillo, ColorConsola_Negro},
	DatosSimboloConsola{(char)62, ColorConsola_Amarillo, ColorConsola_Negro},
	DatosSimboloConsola{(char)13, ColorConsola_Amarillo, ColorConsola_Negro},
	DatosSimboloConsola{(char)174, ColorConsola_Amarillo, ColorConsola_Negro},
	DatosSimboloConsola{(char)219, ColorConsola_Violeta, ColorConsola_Negro},
	DatosSimboloConsola{(char)175, ColorConsola_Amarillo, ColorConsola_Negro},
	DatosSimboloConsola{(char)13, ColorConsola_Amarillo, ColorConsola_Negro},
	DatosSimboloConsola{(char)62, ColorConsola_Amarillo, ColorConsola_Negro},
	DatosSimboloConsola{(char)254, ColorConsola_Amarillo, ColorConsola_Negro},
	DatosSimboloConsola{(char)62, ColorConsola_Amarillo, ColorConsola_Negro} };

const mAvatarDireccion avatarAguila{ make_pair(Direccion{Direccion_Izquierda}, vAvatarIzquierdaAguila) };
/*make_pair(Direccion{Direccion_Derecha}, vAvatarDerechaTanqueEnemigo2),
make_pair(Direccion{Direccion_Arriba}, vAvatarArribaTanqueEnemigo2),
make_pair(Direccion{Direccion_Abajo}, vAvatarAbajoTanqueEnemigo2)*/ 
